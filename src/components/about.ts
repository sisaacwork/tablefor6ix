...
export function mountAbout(container: HTMLElement, store: Store): void {
  ...
  function render(): void {
    ...
    container.innerHTML = `
      ...
      see <strong>The Missing</strong>.</p>
      ...
      cleaned by hand, and maintained in a public repo — the derived database is
      <a href="${REPO_URL}">right here</a>. It will have mistakes and gaps.
